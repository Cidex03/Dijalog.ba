...
class _HomeTaskWidgetState extends State<CategoriesScreen>
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    ...
                                    context.pushNamed('financeScreen');
                                  },
                                  child: Column(
                                    mainAxisSize: MainAxisSize.max,
                                    mainAxisAlignment:
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(0, 4, 0, 0),
                                                  child: Text(
                                                    'Klizište u Tuzlanskom kantonu, veća materijalna šteta.',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyText2
                                                        .override(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(0, 4, 0, 0),
                                                child: Text(
                                                  'Neovlašteno odlaganje smeća u naseljenom području.',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyText2
                                                      .override(
